...
class AdapterSetupConfiguration(Screen, HelpableScreen):
	def __init__(self, session,iface):
		...
		self.oktext = _("Press OK on your remote control to continue.")
		self.reboottext = _("Your SU980 will restart after pressing OK on your remote control.")
	...
	def loadDescription(self):
		if self["menulist"].getCurrent()[1] == 'edit':
			self["description"].setText(_("Edit the network configuration of your SU980.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'test':
			self["description"].setText(_("Test the network configuration of your SU980.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'dns':
			self["description"].setText(_("Edit the Nameserver configuration of your SU980.\n" ) + self.oktext )
		if self["menulist"].getCurrent()[1] == 'scanwlan':
